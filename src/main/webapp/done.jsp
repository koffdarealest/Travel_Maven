<%-- 
    Document   : done
    Created on : Nov 1, 2023, 12:20:18 PM
    Author     : Tung
--%>
            ...
            <div class="container">
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 350px">
                    <div class="d-inline-flex text-white">
                        <h3 class="display-3 text-white text-uppercase">Booking Successfully</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-5 mx-auto" style="margin-top: 50px;">
            <div class="card border-0">
                <div class="card-header bg-primary text-center p-4">
                    <h1 class="text-white m-0">YOUR BOOKING INFORMATION</h1> 
                </div>
                <c:if test="${not empty lastbook and not empty booktour}">
                    <div class="card-body rounded-bottom bg-white p-5">  
                        <div class="form-group">
                            <label style="font-size: 25px;">Name: ${lastbook.cusName}</label>
                        </div>
                        <div class="form-group">
                            <label style="font-size: 25px;">Email: ${lastbook.cusMail}</label>
                        </div>
                        <div class="form-group">
                            <label style="font-size: 25px;">Phone: ${lastbook.cusPhone}</label>
                        </div>
                        <div class="form-group">
                            <label style="font-size: 25px;">Depart Date: ${lastbook.startDate}</label>
                        </div> 
                        <div class="form-group">
                            <label style="font-size: 25px;">Book ID: ${lastbook.bookID}</label>
                        </div>           
                        <div class="form-group">                  
                            <label style="font-size: 25px;">Tour: ${booktour.name} - ${booktour.describe}</label>         
                        </div>
                        <div class="form-group">                  
                            <label style="font-size: 25px;">Duration: ${booktour.numOfDay} days</label>         
                        </div>
                        <div class="form-group">                  
                            <label style="font-size: 25px;">Number Of People: ${booktour.numOfPerson}</label>         
                        </div>
                        <div class="form-group">                  
                            <label style="font-size: 25px;">Price: ${booktour.price}$</label>         
                        </div>
                    </div>
                </c:if>
            </div>
