<%-- 
    Document   : booking
    Created on : Oct 31, 2023, 9:48:08 PM
    Author     : Tung
--%>
        ...
        <div class="col-lg-6 mx-auto" style="margin-top: 50px;">
            <div class="card border-0">
                <div class="card-header bg-primary text-center p-4">
                    <h1 class="text-white m-0">Book your tour</h1>
                </div>
                <div class="card-body rounded-bottom bg-white p-5">
                    <form action="addbook" method="get">
                        ...
                        <div class="form-group" id="date1">
                            <input type="date" class="form-control p-4" placeholder="Depart Date" id="date" name="date"/>
                        </div>                                                              
                        <div class="form-group">
                            <select class="custom-select px-4" style="height: 47px;" name="selectedtour">
                                ...
                                <c:forEach items="${listtour}" var="o">
                                    <option value="${o.ID}" ${o.ID eq chosen.ID ? 'selected' : ''}>${o.name} - ${o.numOfDay} Day - ${o.numOfPerson} Persons - ${o.price}$</option>
                                </c:forEach>
                            </select>
                        </div>                              
                        <div>
