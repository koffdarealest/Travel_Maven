<%-- 
    ...
    Created on : Nov 10, 2023, 3:25:27 AM
    Author     : Tung
--%>
        ...
        <div class="container-fluid page-header">
            <div class="container">
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                    <h2 class="display-4 text-white text-uppercase">Successfully</h2>
                </div>
            </div>
        </div>
        <!-- Header End -->

        <a href="order" style="text-align: center; display: block; margin: 0 auto; font-size: 35px; margin-top: 150px; margin-bottom: 150px" >Back to see your placed order</a>
