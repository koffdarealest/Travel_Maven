<%-- 
    Document   : signup
    Created on : Nov 8, 2023, 8:32:18 AM
    Author     : Tung
--%>
...
<html lang="en">
            ...
            <div class="container"> 
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                    <div class="d-inline-flex text-white">
                        <h2 class="display-4 text-white text-uppercase">Sign up</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-5 mx-auto" style="margin-top: 50px;">
            <div class="card border-0">
                <div class="card-header bg-primary text-center p-4">
                    <h1 class="text-white m-0">Create account</h1> 
                </div>         
                <div class="card-body rounded-bottom bg-white p-5">  
                    <form action="signup" method="post">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control p-4" placeholder="Re-enter your password" name="repassword" required="required" />      
                        </div>
                        <div class="form-group">
                            <input type="tel" class="form-control p-4" placeholder="Your phone number" name="phone" required="required" pattern="[0-9]{10}" title="Please enter a 10-digit phone number!"/>
                        </div>
                        <div>
                            <button class="btn btn-primary btn-block py-3" type="submit">CREATE YOUR ACCOUNT</button>
                            <br>
                            <span id="password-error" style="color: red;">${duperror}</span>
                        </div>
                        <div class="form-group text-center">
                            <br>
                            <a href="login">OR BACK TO SIGN IN</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        // Lấy các ô password và repassword
        const passwordInput = document.getElementById('password');
        const repasswordInput = document.getElementById('repassword');
        const passwordError = document.getElementById('password-error');

        // Thêm sự kiện người dùng nhập liệu (keyup) vào cả hai ô password
