...
public class DoneController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        book lastbook = dao.getLastBook();
        try {
            String selectedtour = session.getAttribute("selectedtour").toString();
            tour tr = dao.getBookTour(selectedtour);
            request.setAttribute("booktour", tr);
        } catch (Exception e) {
        }        
